...
func (oq *OrderQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (oq *OrderQuery) FirstIDX(ctx context.Context) uint {
...
func (oq *OrderQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (oq *OrderQuery) OnlyIDX(ctx context.Context) uint {
...
func (oq *OrderQuery) IDs(ctx context.Context) ([]uint, error) {
	var ids []uint
...
func (oq *OrderQuery) IDsX(ctx context.Context) []uint {
	ids, err := oq.IDs(ctx)
	if err != nil {
		panic(err)
	}
